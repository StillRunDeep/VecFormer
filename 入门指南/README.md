...
每章均有对应的详细阅读文档（点击章节标题跳转），本页保留章节摘要供快速查阅。

| 章节 | 详细文档 | 内容简介 |
|------|---------|---------|
| 1. 项目是干什么的 | [ch01-项目介绍.md](ch01-项目介绍.md) | 任务背景、创新点、论文定位 |
| 2. 必备知识储备 | [ch02-知识储备.md](ch02-知识储备.md) | Python→PyTorch→Transformer 学习路径 |
| 3. 项目整体结构 | [ch03-项目结构.md](ch03-项目结构.md) | 目录导览、各模块职责 |
| 4. 数据从哪来、长什么样 | [ch04-数据.md](ch04-数据.md) | SVGData / VecData / 变长打包 |
| 5. 模型架构：从输入到输出 | [ch05-模型架构.md](ch05-模型架构.md) | 骨干网络 / 解码器 / 损失函数 |
| 6. 训练流程 | [ch06-训练流程.md](ch06-训练流程.md) | 训练循环、配置、启动脚本 |
| 7. 代码阅读路线图 | [ch07-阅读路线.md](ch07-阅读路线.md) | 六阶段阅读建议 |
| 8. 常见概念速查 | [ch08-概念速查.md](ch08-概念速查.md) | 术语表 |
| 9. 推理流程详解 | [ch09-推理流程.md](ch09-推理流程.md) | 语义/实例/全景预测 + NMS |
| 10. 项目中的设计模式 | [ch10-设计模式.md](ch10-设计模式.md) | Registry / Trainer / PointModule |
| 11. 完整前向传播追踪 | [ch11-前向传播.md](ch11-前向传播.md) | 逐层张量维度变化 |
| 12. 常见问题与解决 | [ch12-常见问题.md](ch12-常见问题.md) | OOM / flash_attn / 调试技巧 |
